...
- 平台聚合的 **270+ 信源均为公开订阅端点**：公开 RSS/Atom 地址，以及 GitHub、arXiv、HuggingFace、GDELT 等公开 API。
- 所有资讯的**版权与知识产权归原发布方 / 原作者所有**。平台仅做标题、摘要与元数据级的聚合检索，正文阅读始终跳转原文链接；配图与署名来自原发布方，版权归原作者。
- 聚合结果仅供个人学习与研究使用，请勿将平台内容用于商业再分发。
- 如您是信源作者 / 版权方，不希望内容被本平台收录，请通过下方「关于作者」的联系方式告知，核实后我们会移除对应信源。
...
**潘裕丰** —— 独立开发者，SiliconStream · 万般硅川 的设计与实现者。

| 渠道 | 信息 |
| --- | --- |
| 📮 QQ 邮箱 | [2818932783@qq.com](mailto:2818932783@qq.com) |
| 📱 电话 | 15259751931 |
| 💬 微信 | 江月光于水 · 扫码添加 |

<p align="center"><img src="public/qr/wechat.png" alt="微信二维码" width="240" /></p>

> 欢迎交流 AI 资讯聚合、Agent 工作流与个人知识管理；反馈与合作同样欢迎。
