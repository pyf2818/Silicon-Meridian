...
export const PRIMARY_NAV_ITEMS = [
  ...
  { id: 'studio', labelKey: 'nav.studio', descKey: 'nav.materialsGraph', shortKey: 'nav.studio', icon: 'layers', nav: 'studio', children: [] },
  { id: 'canvas', labelKey: 'nav.canvas', descKey: 'nav.canvasDesc', shortKey: 'nav.canvas', icon: 'workflow', nav: 'canvas', children: [] },
...
export const ICONS = {
  ...
  workflow: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="4" width="6" height="6" rx="1"/><rect x="16" y="14" width="6" height="6" rx="1"/><path d="M8 7h4a2 2 0 0 1 2 2v3a2 2 0 0 0 2 2h0"/><circle cx="5" cy="17" r="2"/><path d="M7 17h5"/></svg>,
